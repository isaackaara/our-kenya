...
const GRAPH_CATEGORIES: GraphCategory[] = [
  ...
  { label: "Corporate", topics: ["safaricom-story","equity-bank-story","nakumatt-collapse","kenya-airways-story","chandaria-story","keroche-story","nation-media-story","silicon-savannah-story"] },
]
...
const GRAPH_DATA: Record<string, GraphDataset> = {
  ...
  "chandaria-story": {
    id: "chandaria-story",
    label: "Manu Chandaria & Asian Dynasties",
    nodes: [
      { id: "chandaria",    label: "Manu Chandaria",          type: "center",  href: "/Asians/Manu-Chandaria",                       desc: "Kenya's most celebrated industrialist. Comcraft Group. 40+ countries. Gave most of it away." },
      { id: "chandaria-g",  label: "Chandaria Group",         type: "entity",  href: "/Asians/Chandaria-Group",                      desc: "The Chandaria family empire. Aluminium, cables, packaging. Built from Nairobi outward." },
      { id: "chandaria-i",  label: "Chandaria Industries",    type: "entity",  href: "/Corporate-Kenya/Chandaria-Industries",         desc: "The manufacturing arm. Steel, aluminium, consumer goods. Quietly dominant." },
      { id: "asian-fam",    label: "Asian Business Families", type: "concept", href: "/Corporate-Kenya/Kenyan-Asian-Business-Families",desc: "The Shahs, Chandarias, Mehtas, Patels. Asian families built Kenya's manufacturing and retail backbone." },
      { id: "bidco",        label: "Bidco Africa",            type: "entity",  href: "/Corporate-Kenya/Bidco-Africa",                desc: "The Vimal Shah family. Cooking oil, soap, margarine. Africa's biggest FMCG family story." },
      { id: "devki",        label: "Devki Group",             type: "entity",  href: "/Corporate-Kenya/Devki-Group",                 desc: "The Rai family. Steel and cement. Built by a man who started with a bicycle." },
      { id: "asian-media",  label: "Kenyan Asian Media",      type: "concept", href: "/Asians/Kenyan-Asian-Media",                   desc: "Radio Salaam, vernacular press, the Asian community's parallel media ecosystem." },
      { id: "mfg-hist",     label: "Manufacturing History",   type: "concept", href: "/Corporate-Kenya/Manufacturing-History-Kenya",  desc: "From colonial processing plants to a $10B manufacturing sector. Asian families drove most of it." },
      { id: "eab-c",        label: "East African Breweries",  type: "entity",  href: "/Corporate-Kenya/East-African-Breweries",       desc: "EABL. Part-owned by Diageo. Asian founders. Kenya's most recognised brand." },
    ],
    links: [
      { source: "chandaria",  target: "chandaria-g",  type: "founded",  label: "built Comcraft" },
      { source: "chandaria",  target: "chandaria-i",  type: "owns",     label: "manufacturing arm" },
      { source: "asian-fam",  target: "chandaria",    type: "part-of",  label: "Chandaria as patriarch" },
      { source: "asian-fam",  target: "bidco",        type: "part-of",  label: "Vimal Shah" },
      { source: "asian-fam",  target: "devki",        type: "part-of",  label: "Narendra Rai" },
      { source: "asian-fam",  target: "eab-c",        type: "part-of",  label: "Asian founders" },
      { source: "chandaria-i",target: "mfg-hist",     type: "shapes",   label: "industrialised Kenya" },
      { source: "asian-fam",  target: "asian-media",  type: "built",    label: "community media" },
      { source: "bidco",      target: "mfg-hist",     type: "part-of",  label: "FMCG manufacturing" },
    ],
  },

  "keroche-story": {
    id: "keroche-story",
    label: "Keroche Breweries",
    nodes: [
      { id: "keroche",      label: "Keroche Breweries",      type: "center",  href: "/Corporate-Kenya/East-African-Breweries",       desc: "Tabitha Karanja's brewery. Built from scratch to challenge EABL's century-long monopoly." },
      { id: "tabitha",      label: "Tabitha Karanja",        type: "person",  href: "/Corporate-Kenya/Women-in-Kenyan-Business",     desc: "Founded Keroche at 36. Fought KRA, EABL, and received death threats. Became senator." },
      { id: "eabl-k",       label: "East African Breweries", type: "entity",  href: "/Corporate-Kenya/East-African-Breweries",       desc: "Tusker, Guinness, White Cap. Diageo-owned. Dominant for 100 years before Keroche." },
      { id: "tusker",       label: "Kenya Breweries & Tusker",type:"entity",  href: "/Corporate-Kenya/Kenya-Breweries-and-Tusker",   desc: "Tusker. Kenya's national beer. The brand Keroche had to beat to be taken seriously." },
      { id: "kra-k",        label: "Kenya Revenue Authority",type: "entity",  href: "/Corporate-Kenya/Kenya-Revenue-Authority",      desc: "KRA billed Keroche billions in disputed taxes. The fight nearly killed the company twice." },
      { id: "kenyatta-biz", label: "Kenyatta Family Business",type:"entity",  href: "/Corporate-Kenya/Kenyatta-Family-Business",     desc: "The Kenyatta family owned EABL shares. The politics of beer in Kenya were never neutral." },
      { id: "women-biz",    label: "Women in Kenyan Business",type:"concept", href: "/Corporate-Kenya/Women-in-Kenyan-Business",     desc: "Tabitha Karanja as a symbol. Women-owned enterprises against old-boy networks." },
      { id: "trade-unions-k",label:"Trade Union History",    type: "concept", href: "/Corporate-Kenya/Trade-Union-History-Kenya",    desc: "Brewery workers unions. Labour rights in manufacturing. Keroche as employer story." },
      { id: "post-ind-k",   label: "Post-Independence Policy",type:"concept", href: "/Corporate-Kenya/Post-Independence-Economic-Policy",desc: "The licensing regime that protected EABL for decades. Keroche forced it open." },
    ],
    links: [
      { source: "keroche",    target: "tabitha",      type: "founded",  label: "founded by Karanja" },
      { source: "keroche",    target: "eabl-k",       type: "rivals",   label: "challenged monopoly" },
      { source: "eabl-k",     target: "tusker",       type: "owns",     label: "flagship brand" },
      { source: "kra-k",      target: "keroche",      type: "pressure", label: "tax dispute" },
      { source: "kenyatta-biz",target:"eabl-k",       type: "invested", label: "family shareholding" },
      { source: "tabitha",    target: "women-biz",    type: "symbol",   label: "role model" },
      { source: "keroche",    target: "trade-unions-k",type:"employer", label: "labour relations" },
      { source: "post-ind-k", target: "eabl-k",       type: "protected",label: "licensing protection" },
      { source: "keroche",    target: "post-ind-k",   type: "broke",    label: "forced market open" },
    ],
  },

  "nation-media-story": {
    id: "nation-media-story",
    label: "Nation Media Group",
    nodes: [
      { id: "nmg",          label: "Nation Media Group",      type: "center",  href: "/Asians/Nation-Media-Group",                   desc: "The Aga Khan's media empire. Daily Nation, NTV, Nation FM. The paper of record since 1960." },
      { id: "daily-nation", label: "Daily Nation",            type: "entity",  href: "/Media/Daily-Nation-Establishment",            desc: "Kenya's most-read newspaper. Launched 1960. Beat the East African Standard at independence." },
      { id: "std-grp",      label: "Standard Group",          type: "entity",  href: "/Media/Standard-Digital-Group",                desc: "The rival. East African Standard. Government-linked. NMG vs Standard = Kenya's media war." },
      { id: "east-af-std",  label: "East African Standard",   type: "entity",  href: "/Media/East-African-Standard",                 desc: "Colonial paper. Became Standard. Raided by Kibaki's government in 2006. Still publishing." },
      { id: "std-raid",     label: "Standard Media Raid 2006",type: "event",   href: "/Presidencies/Mwai-Kibaki-Presidency/Standard-Media-Raid-2006", desc: "State agents raided Standard Group at 3am. Burned newspapers. Kenya's darkest press freedom night." },
      { id: "royal-media",  label: "Royal Media Services",    type: "entity",  href: "/Media/Royal-Media-Services",                  desc: "Citizen TV, Inooro, Radio Citizen. S.K. Macharia's empire. Third force in Kenyan media." },
      { id: "media-own",    label: "Media Ownership Control", type: "concept", href: "/Media/Media-Ownership-Control",               desc: "Who controls what Kenya reads and watches. Political ownership behind every masthead." },
      { id: "digital-shift",label: "Digital Media Shift",     type: "event",   href: "/Media/Digital-Media-Shift",                   desc: "Print collapse. Digital rise. NMG fought social media and lost circulation, then adapted." },
      { id: "media-consol", label: "Media Consolidation",     type: "concept", href: "/Media/Media-Consolidation",                   desc: "NMG buying regional outlets. The East Africa media map shrinking to a few owners." },
      { id: "nmg-hist",     label: "NMG History",             type: "concept", href: "/Media/Nation-Media-Group-History",            desc: "From a single newspaper to a regional media conglomerate in five decades." },
    ],
    links: [
      { source: "nmg",       target: "daily-nation",  type: "flagship", label: "flagship paper" },
      { source: "nmg",       target: "std-grp",       type: "rivals",   label: "defining rivalry" },
      { source: "std-grp",   target: "east-af-std",   type: "owns",     label: "parent company" },
      { source: "std-raid",  target: "std-grp",       type: "targeted", label: "government raid 2006" },
      { source: "media-own", target: "nmg",           type: "shapes",   label: "Aga Khan ownership" },
      { source: "media-own", target: "royal-media",   type: "shapes",   label: "S.K. Macharia" },
      { source: "digital-shift",target:"nmg",         type: "disrupted",label: "circulation hit" },
      { source: "nmg",       target: "media-consol",  type: "drives",   label: "regional acquisitions" },
      { source: "nmg",       target: "nmg-hist",      type: "has",      label: "60-year history" },
    ],
  },

  "silicon-savannah-story": {
    id: "silicon-savannah-story",
    label: "Silicon Savannah",
    nodes: [
      { id: "sil-sav",     label: "Silicon Savannah",         type: "center",  href: "/Corporate-Kenya/Silicon-Savannah",            desc: "Nairobi as Africa's tech capital. The name was aspirational in 2007. Now it's a fact." },
      { id: "ihub",        label: "iHub Nairobi",             type: "place",   href: "/Corporate-Kenya/iHub-Nairobi",                desc: "Launched 2010. Africa's first open innovation hub. Incubated Ushahidi, mFarm, 170+ companies." },
      { id: "ushahidi",    label: "Ushahidi",                 type: "entity",  href: "/Corporate-Kenya/Ushahidi",                   desc: "Born from 2007 election violence. Open-source crisis mapping used in Haiti, Libya, everywhere." },
      { id: "startups-k",  label: "Kenyan Startups",          type: "concept", href: "/Corporate-Kenya/Kenyan-Startups",             desc: "Twiga Foods, Sendy, Sokowatch. The wave of venture-backed companies Nairobi produced post-2010." },
      { id: "internet-k",  label: "Internet Kenya",           type: "concept", href: "/Corporate-Kenya/Internet-Kenya",              desc: "From 2% internet penetration in 2007 to 40%+ by 2020. The infrastructure story behind the startups." },
      { id: "cables-k",    label: "Submarine Cables",         type: "event",   href: "/Corporate-Kenya/Submarine-Cables-Kenya",      desc: "SEACOM, EASSy cables hit Kenya 2009-2010. Bandwidth prices dropped 90%. Silicon Savannah began here." },
      { id: "konza",       label: "Konza Technopolis",        type: "place",   href: "/Corporate-Kenya/Konza-Technopolis",           desc: "The planned city 60km from Nairobi. Vision 2030 tech hub. Still mostly a promise." },
      { id: "ecomm-k",     label: "E-Commerce Kenya",         type: "concept", href: "/Corporate-Kenya/E-Commerce-Kenya",            desc: "Jumia, Kilimall, Copia. The e-commerce wave. Most failed. A few changed retail." },
      { id: "fintech-ss",  label: "Fintech Kenya",            type: "concept", href: "/Corporate-Kenya/Fintech-Kenya",               desc: "M-Kopa, Branch, Tala. M-Pesa rails became the platform for Africa's biggest fintech cluster." },
      { id: "gov-digit",   label: "Government Digitisation",  type: "event",   href: "/Corporate-Kenya/Government-Digitisation",     desc: "eCitizen, Huduma Centres, digital IDs. Government as anchor client for Kenyan tech." },
    ],
    links: [
      { source: "sil-sav",  target: "ihub",          type: "anchored", label: "iHub as centre" },
      { source: "ihub",     target: "ushahidi",       type: "incubated",label: "early tenant" },
      { source: "ihub",     target: "startups-k",     type: "spawned",  label: "170+ companies" },
      { source: "cables-k", target: "internet-k",     type: "enabled",  label: "bandwidth crash" },
      { source: "internet-k",target:"sil-sav",        type: "foundation",label: "infrastructure" },
      { source: "sil-sav",  target: "fintech-ss",     type: "produced", label: "M-Pesa ecosystem" },
      { source: "sil-sav",  target: "ecomm-k",        type: "produced", label: "e-commerce wave" },
      { source: "konza",    target: "sil-sav",         type: "vision",   label: "planned expansion" },
      { source: "gov-digit",target: "sil-sav",         type: "anchors",  label: "government as client" },
    ],
  },
