...
Our Kenya (ourkenya.com) is a knowledge graph of Kenya's history built as a Quartz v4.5.2 static site. 7,759+ notes, 140 story trails, 58 interactive knowledge graphs. Deployed on Cloudflare Pages.
...
- **Build time:** ~60 seconds for 7,759+ files + ~13 seconds for pagefind indexing
