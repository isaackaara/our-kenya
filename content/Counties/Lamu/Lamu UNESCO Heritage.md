...
Tensions have emerged between preservation and development, particularly regarding the [[LAPSSET Lamu|LAPSSET]] port project. The port is being built on the mainland near Lamu, not in the Old Town itself, but the development creates infrastructure pressure, labor migration, and speculation. Some argue that the port will ultimately threaten Lamu's isolation and heritage character. UNESCO and conservation organizations have raised concerns about the project's potential indirect impacts.
...
1. UNESCO World Heritage Centre. "Lamu Old Town: Inscription Document." https://whc.unesco.org/en/list/500/
2. Chami, Felix A. "The Archaeology of the Swahili Coastal Towns." (In The Swahili World, 2018).
3. Saleh, Mohamed Hassan. "Managing World Heritage Sites: The Case of Lamu." (African Journal of Archaeology, 2009).
4. International Council on Monuments and Sites (ICOMOS). "Lamu Old Town Conservation Assessment." (2001).
