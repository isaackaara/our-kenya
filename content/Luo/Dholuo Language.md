...
2. [Luo Languages and Nilotic Classification - Wikipedia](https://en.wikipedia.org/wiki/Luo_languages) - Detailed linguistic classification placing Dholuo within Luo language group, discussion of related languages (Acholi, Alur, Lango), and relationship to Dinka-Nuer within Western Nilotic family
3. [Dholuo Grammar and Linguistic Structure](https://people.umass.edu/scable/LING748-FA09/Materials/Handouts/Dholuo-Basics.pdf) - University of Massachusetts linguistic analysis of Dholuo grammar, tonality, phonology, and morphological features with comparison to related Nilotic languages
