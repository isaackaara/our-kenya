...
Ismailis are members of the Shia branch of Islam who recognize the Aga Khan as their spiritual leader and hereditary Imam. The current Aga Khan (His Highness Prince Karim Aga Khan IV) is the 49th Imam. Ismailis come from various ethnic and regional backgrounds ([[Gujarati Dominance in Business|Gujarati]], Pakistani, East African born), but are unified by faith and loyalty to the Aga Khan. Unlike many other Muslim communities, Ismailis emphasize education, business acumen, and social integration with secular institutions.
...
1. Wikipedia: "Aga Khan Development Network" (https://en.wikipedia.org/wiki/Aga_Khan_Development_Network)
2. AKDN Official Website: "AKDN in Kenya" (https://the.akdn/en/where-we-work/eastern-africa/kenya)
3. Aga Khan Foundation: "About the Aga Khan Development Network" (https://akf.org/about-the-aga-khan-development-network/)
