...
While Somali is the dominant language of the Somali people, there is some linguistic diversity within Somali language itself. Dialects vary by region and [[Somali Clan System Kenya|clan]]. However, the standardized script and mutual intelligibility mean that regional dialects are not mutually unintelligible. The standardization process has promoted a unified Somali identity across regional variation.
